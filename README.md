...
You can also append some options when sourcing file to customize your experience. For instance, you may add `noprompt` option to disable installation prompt or `su` to use 'su' utility instead of sudo to get root access. For example:

	source /usr/share/doc/find-the-command/ftc su
